                  ...
                  <table class="table table-striped">
                    <tbody id="show_data">
                      <?php foreach ($sk as $a): ?>
                        ...
                        <tr>
                          <td><a href="<?php echo site_url('pimpinan/suratkeluar/downloadsk/'.$a->filesurat); ?>" class="btn btn-default">Download Surat</a>
                          </td>
                        ...
                        <tr>
                          ...
                          <?php if ($a->filelampiran != NULL) { ?>
                            <td><a href="<?php echo site_url('pimpinan/suratkeluar/downloadlmp/'.$a->filelampiran); ?>" class="btn btn-default">Download Lampiran</a></td>
                          <?php  } else{ ?>
