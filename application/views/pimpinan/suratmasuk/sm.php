                ...
                <div class="x_content">
                  <table id="datatable" class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <?php if ($a->statusbaca == 'Belum Dibaca') { ?>
                            <img src="<?php echo base_url('img/mail.png'); ?>">
                        <?php  } elseif ($a->statusbaca == 'Sudah Dibaca') { ?>
                        ...
                        <td>
                          <a href="<?php echo site_url('pimpinan/suratmasuk/detailsm/'.$a->idsm); ?>" class="btn btn-default">Buka Surat</a>
                        </td>
                      </tr>
                    <?php } ?>
                    </tbody>
