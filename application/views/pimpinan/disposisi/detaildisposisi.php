                    ...
                    <tbody id="show_data">
                      <?php foreach ($dsp as $a): ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $a->nama.' - '.$a->jabatan; ?></td>
                        </tr>
                        <tr>
                          <td>Tanggal Disposisi</td>
                          <td><?php echo $a->tanggaldisposisi; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <?php }else if($level == 'operator'){ ?>
                            <td><a href="<?php echo site_url('operator/disposisi/downloadsm/'.$a->filesurat); ?>" class="btn btn-default">Download Surat</a>
                          <?php }else if($level == 'administrator'){ ?>
                            <td><a href="<?php echo site_url('administrator/disposisi/downloadsm/'.$a->filesurat); ?>" class="btn btn-default">Download Surat</a>
                          <?php }else if($level == 'staf'){ ?>
                            <td><a href="<?php echo site_url('staf/disposisi/downloadsm/'.$a->filesurat); ?>" class="btn btn-default">Download Surat</a>
                          <?php } ?>
                        ...
                        <tr>
                          ...
                          <?php if ($level == 'pimpinan'): ?>
                            <td><a href="javascript:;" class="btn btn-default" id="disposisi" data="<?=$a->iddisposisi; ?>" data-toggle="modal" data-target="#ModalDisposisi">Disposisi Surat</a></td>
                          <?php else: ?>
                            <td></td>
                          <?php endif; ?>
                          <?php if ($a->filelampiran != NULL) { ?>
                            ...
                            <?php }else if($level == 'operator'){ ?>
                              <td><a href="<?php echo site_url('operator/disposisi/downloadlmp/'.$a->filelampiran); ?>" class="btn btn-default">Download Lampiran</a></td>
                            <?php }else if($level == 'administrator'){ ?>
                              <td><a href="<?php echo site_url('administrator/disposisi/downloadlmp/'.$a->filelampiran); ?>" class="btn btn-default">Download Lampiran</a></td>
                            <?php }else if($level == 'staf'){ ?>
                              <td><a href="<?php echo site_url('staf/disposisi/downloadlmp/'.$a->filelampiran); ?>" class="btn btn-default">Download Lampiran</a></td>
                            <?php } ?>
                          <?php  } else{ ?>
        ...
        <div class="modal fade bs-example-modal-lg" id="ModalDisposisi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <?php if ($disposisi > 0): ?>
                <br> &nbsp; <br>
                <h3 style="text-align:center">Data Disposisi Sudah Dikirim Kepada Penerima Disposisi</h3> <br> &nbsp; <br>
              <?php else: ?>
                <form class="form-horizontal" method="post" enctype="multipart/form-data" role="form">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="col-lg-6">
                        <input type="hidden" name="idsm" id="idsm" value="<?php echo $a->idsm;?>">
                      </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
 ...
 function datadisposisi(){
   ...
   $.ajax({
     type  : "POST",
     url   : "<?php echo base_url('pimpinan/disposisi/datadisposisi')?>",
     dataType : "JSON",
     data: "id="+id,
     success : function(data){
       var html = '';
 ...
 $('#btntambah').on('click',function(){
      ...
      $.ajax({
          type : "POST",
          url  : "<?php echo base_url('pimpinan/disposisi/simpandisposisi')?>",
          dataType : "JSON",
          data : {tujuandisposisi:tujuandisposisi , idsm:idsm, isidisposisi:isidisposisi, sifatdisposisi:sifatdisposisi, catatan:catatan, parent:id},
          success: function(data){
