                  ...
                  <form class="form-horizontal form-label-left" action="<?php echo base_url('administrator/pegawai/prosestambahpegawai'); ?>" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="nip" placeholder="Masukkan Nomor Induk Pegawai" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="nama" placeholder="Masukkan Nama Pegawai" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="3"  name="tempatlahir" placeholder="Masukkan Tempat Lahir" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tanggal Lahir <span class="required">*</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="tanggallahir" class="form-control has-feedback-left" id="datepicker"  placeholder="Masukkan Tanggal Lahir">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="nohp" placeholder="Masukkan No Handphone" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" id="email" name="email" required="required" class="form-control col-md-7 col-xs-12" placeholder="Masukkan Email Pegawai">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="textarea" required="required" name="alamat" class="form-control col-md-7 col-xs-12" placeholder="Masukkan Alamat Pegawai"></textarea>
                      </div>
                    </div>
