  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
                ...
                <div class="x_content">
                  ...
                  <table class="table table-striped">
                    <tbody>
                      <?php foreach ($sk as $a): ?>
                        <tr>
                          <td>ID Register Surat Keluar</td>
                          <td><?php echo $a->idsk; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><?php echo $a->tujuansurat; ?></td>
                        </tr>
                        <tr>
                          <td>Penanggung Jawab Surat Keluar</td>
                        ...
                        <tr>
                          <td><a href="<?php echo site_url('operator/suratkeluar/downloadsk/'.$a->filesurat); ?>" class="btn btn-default">Download Surat</a>
                          </td>
                          <?php if ($a->filelampiran != NULL) { ?>
                            <td><a href="" data-toggle="modal" data-target="#editdata<?=$a->idsk; ?>" class="btn btn-default">Lihat Lampiran</a></td>
                          <?php  } else{ ?>
                        ...
                        <tr>
                          <?php if ($a->filelampiran != NULL) { ?>
                            <td><a href="<?php echo site_url('operator/suratkeluar/downloadlmp/'.$a->filelampiran); ?>" class="btn btn-default">Download Lampiran</a></td>
                          <?php  } else{ ?>
        ...
        <?php foreach($sk as $a): ?>
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="editdata<?=$a->idsk; ?>">
