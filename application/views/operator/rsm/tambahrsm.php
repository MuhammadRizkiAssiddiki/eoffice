                  ...
                  <form class="form-horizontal form-label-left" action="<?php echo base_url('operator/registersurat/prosestambahrsm'); ?>" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" value="<?php echo $kode; ?>" name="idrsm" readonly="readonly" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" name="tujuansurat" required="required">
