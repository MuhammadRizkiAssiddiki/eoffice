...
class Sendmail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config = [
            ...
            'smtp_user' => 'encikassik@gmail.com',  // Email gmail
            'smtp_pass'   => 'nevergiveup123',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('encikassik@gmail.com', 'Testing');

        // Email penerima
        $this->email->to('namakuassik@gmail.com'); // Ganti dengan email tujuan
